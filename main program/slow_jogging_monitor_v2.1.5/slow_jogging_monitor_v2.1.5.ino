...
void showdata(){
  ...
  if (handOn){
    ...
    else if(beatAvg < 105) sprite.fillRect(300, 10, 10, 150, TFT_BLUE);
    else if(beatAvg >= 105 && beatAvg <= 125) sprite.fillRect(300, 10, 10, 150, TFT_GREEN);
    else sprite.fillRect(300, 10, 10, 150, TFT_RED);
